...
# Paso de cuantización de color
DEFAULT_QUANTIZE_STEP = 10

# Dimensiones por defecto para pixelado
DEFAULT_WIDTH = 32
DEFAULT_HEIGHT = 32
DEFAULT_BLOCK_SIZE = 1

# Nombre por defecto de la paleta
DEFAULT_PALETTE_NAME = "mi_paleta"

# Dimensión del preview canvas
...
# Colores de interfaz
UI_BACKGROUND_COLOR = "#1e1e1e"  # fondo general
UI_FOREGROUND_COLOR = "#ffffff"  # texto
